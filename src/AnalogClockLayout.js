...
export default function AnalogClockLayout({ hour, minutes, seconds, styles, width }) {
    ...
    const secondStyle = Object.assign({}, styles.second, {
        transform: `translateX(-50%) translateY(-100%) rotate(${seconds * 6 + 0.5}deg)`,
    });
    // +0.5 to center align
    const minuteStyle = Object.assign({}, styles.minute, {
        transform: `translateX(-50%) translateY(-100%) rotate(${minutes * 6 + 0.5}deg)`,
    });
    // console.log('styles.minute',styles.minute)
    // console.log('minuteStyle',minuteStyle)
    // +0.5 to center align
    const hourStyle = Object.assign({}, styles.hour, {
        transform: `translateX(-50%) translateY(-100%) rotate(${(hour * 30) + (minutes / 2) + 0.5}deg)`,
    });
    return (
